        ...
        <div ref={playerShell} className="player-shell">
          ...
          <div className="player-controls" aria-label="Video controls">
            ...
            <div className="player-transport">
              ...
              <button type="button" className="transport-button" onClick={() => rotate(-90)} aria-label="Rotate left"><span aria-hidden="true">↶</span></button>
              ...
              <button type="button" className="transport-button" onClick={() => rotate(90)} aria-label="Rotate right"><span aria-hidden="true">↷</span></button>
